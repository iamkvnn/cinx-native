import { ApiResponseObject, ApiResponseVoid, ApiResponseBoolean, ApiResponseListString, ApiResponseListUserDto, ApiResponseUserDto, CreateUserRequest, DeviceTokenRequest, PaginatedApiResponseUserDto, UpdateProfileRequest } from "@/types";
...
export class UserControllerService {
    ...
    public static updateUser({
        ...
        return axiosClient.put(`/api/v1/users/${id}`, formData);
    }
    /**
    ...
    public static getAvatarImage({
        ...
        return axiosClient.get(`/api/v1/users/avatars/${fileName}`, { responseType: 'blob' });
    }
}
