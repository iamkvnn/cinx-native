import {
  ApiResponseAssignmentSubmissionResponse,
  CreateAssignmentSubmissionRequest,
  PaginatedApiResponseAssignmentSubmissionResponse,
  ApiResponseObject,
} from "@/types";
...
export class AssignmentControllerService {
  ...
  public static submitAssignment({
    ...
    return axiosClient.post(
      "/api/v1/learning/assignment-submissions",
      requestBody,
      {
        params: {
          assignmentId: assignmentId,
  ...
  public static scoreAssignmentSubmission({
    ...
    return axiosClient.post(
      `/api/v1/learning/assignment-submissions/${submissionId}/score`,
      null,
      {
        params: {
          score: score,
  ...
  public static deleteAssignmentSubmission({
    ...
    return axiosClient.delete(
      `/api/v1/learning/assignment-submissions/${submissionId}`,
    );
  }
}
